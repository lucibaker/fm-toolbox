function [rvec,avec,avcorr_u,varargout] = avcorr_2D_mirror_2(pos,rvec,sectors,xlim,ylim,mirror,pvar,quarters,q_idx)
...
for t = 1:length(pos2)
    ...
    for p=1:size(pos,1)
       ...
       u12_array(lastpos+1:lastpos+np) = (posmir(:,q_idx).*pos1(:,q_idx)); 
