function [rbin,rvec,thvec]=twopoint_corr(C,r_edges,theta_edges,xlims,ylims,ixlims,iylims)
% Parameters:
%   C       matrix (n,4) of n (x,y,u,v) particle locations and associated velocities in a single realization
%           OR cell array of (n,4) matrices containing particle locs and vels in multiple realizations
...
% particles and their associated velocities, a vector of shell radii, and a
% vector of angles, and finds the non-normalized two-point correlation.
%
